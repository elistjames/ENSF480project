...
public class RenterController extends UserController {
     ...
     * @param currentUser {Renter} The User currently signed in.
     * @param renterV {RenterView} The GUI interface for the renter
     */
     ...
     * @param name {String} Name of registering renter
     * @param username {String} Username of registering renter
     * @param password {String} Password of registering renter
     * @param email {String} Email of registering renter
     */
     ...
     */
    public void contactButtonActionPerformed() {
        if(current.getUserID() == 0){
